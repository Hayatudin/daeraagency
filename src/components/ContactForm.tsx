        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-8">
            <div className="flex flex-col gap-5 text-left">
              <span className="text-xs font-bold uppercase tracking-wider text-brand-600 bg-brand-100 border border-brand-200 px-3.5 py-1 rounded-full w-fit">
                Contact Info
              </span>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-4 p-5 rounded-2xl bg-white border border-brand-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col gap-0.5 text-left">
                  <span className="text-[10px] text-navy-400 font-bold uppercase tracking-wider">Call Agent</span>
                  <a href="tel:0924054412" className="text-base font-extrabold text-navy-900 hover:text-brand-600 transition-colors">
                    0924054412
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-5 rounded-2xl bg-white border border-brand-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col gap-0.5 text-left">
                  <span className="text-[10px] text-navy-400 font-bold uppercase tracking-wider">WhatsApp Calling</span>
                  <a href="https://wa.me/251924054412" target="_blank" rel="noopener noreferrer" className="text-base font-extrabold text-navy-900 hover:text-brand-600 transition-colors">
                    +251 924 054 412
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-5 rounded-2xl bg-white border border-brand-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col gap-0.5 text-left">
                  <span className="text-[10px] text-navy-400 font-bold uppercase tracking-wider">Email Inquiry</span>
                  <a href="mailto:ziyusheka@gmail.com" className="text-base font-extrabold text-navy-900 hover:text-brand-600 transition-colors break-all">
                    ziyusheka@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-5 rounded-2xl bg-white border border-brand-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col gap-0.5 text-left">
                  <span className="text-[10px] text-navy-400 font-bold uppercase tracking-wider">Office Location</span>
                  <span className="text-sm font-extrabold text-navy-900 leading-snug">
            ...
            {/* Response Pledge */}
            <div className="flex gap-3 items-center text-xs font-semibold text-navy-500 bg-brand-50/50 border border-brand-100/50 p-4 rounded-2xl mt-2">
              <Clock className="w-4 h-4 text-brand-500 flex-shrink-0 animate-pulse-slow" />
